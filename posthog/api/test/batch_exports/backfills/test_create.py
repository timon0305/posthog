...
def test_batch_export_backfill_for_weekly_schedule_fails_if_day_of_week_is_incorrect(
    ...
    assert (
        ...
        == "Input 2026-01-04 is not on the correct day of the week for this batch export. 2026-01-04 is a Sunday but this batch export is configured to run weekly on Monday."
    )
