# Semgrep test file for hogql-no-fstring.yaml rules
# Run with: semgrep --test .semgrep/rules/
#
# Test annotations:
# - `# ruleid: <rule-id>` - expects the rule to match on the next line
# - `# ok: <rule-id>` - expects the rule to NOT match on the next line

from posthog.hogql import ast
from posthog.hogql.parser import parse_expr, parse_select, parse_order_expr
