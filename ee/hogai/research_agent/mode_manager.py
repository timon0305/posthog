...
from ee.hogai.core.plan_mode import APPROVAL_TASK_PROMPT, ONBOARDING_TASK_PROMPT, PLANNING_TASK_PROMPT
...
class PlanAgentPromptBuilder(ResearchAgentPromptBuilderBase):
    def _get_system_prompt(self) -> str:
        return format_prompt_string(
            ...
            approval_task=APPROVAL_TASK_PROMPT,
...
class ResearchAgentModeManager(AgentModeManager):
    ...
    def toolkit_class(self) -> type[AgentToolkit]:
        return SwitchToResearchAgentToolkit if self._supermode == AgentMode.RESEARCH else PlanAgentToolkit
