...
class TestResearchAgentToolsExecutable(ClickhouseTestMixin, BaseTest):
    ...
    def test_should_transition_returns_true_when_agent_mode_is_research(self):
        """Test that _should_transition returns True when result.agent_mode is RESEARCH."""
        state = AssistantState(messages=[HumanMessage(content="Test")])
    ...
    def test_should_transition_returns_false_when_agent_mode_is_not_research(self):
        """Test that _should_transition returns False when result.agent_mode is not RESEARCH."""
        state = AssistantState(messages=[HumanMessage(content="Test")])
    ...
    def test_should_transition_returns_false_when_agent_mode_is_none(self):
        """Test that _should_transition returns False when result.agent_mode is None."""
        state = AssistantState(messages=[HumanMessage(content="Test")])
