...
class TestResearchAgentModeManager(BaseTest):
    ...
    def test_init_defaults_agent_mode_to_product_analytics(self):
    ...
    def test_supermode_registries_plan_mode_includes_research(self):
        ...
        self.assertIn(AgentMode.PRODUCT_ANALYTICS, plan_registry)
    ...
    def test_toolkit_class_returns_research_toolkit_for_supermode(self):
        ...
        self.assertEqual(mode_manager.toolkit_class, SwitchToResearchAgentToolkit)
